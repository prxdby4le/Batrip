<?php $pageTitle = 'Camiseta Fragmentado Oversized | Batrip'; ?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 mb-4 mb-md-0">
                    <div class="product-image-store">
                        <img src="/Batrip/assets/img/fragmentado-frente.jpeg" alt="Camiseta Fragmentado Oversized" class="img-fluid rounded product-img-store">
                    </div>
                </div>
                <div class="col-md-6">
                    <h2 class="product-title mb-2">Camiseta Fragmentado Oversized</h2>
