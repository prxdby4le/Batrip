        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <a href="mailto:contato@batrip.com" class="footer-link">
                    <i class="bi bi-envelope"></i> contato@batrip.com
                </a>
                <a href="tel:+5511123456789" class="footer-link">
                    <i class="bi bi-phone"></i> (11) 123456789
                </a>
                <p class="footer-link">
                    <i class="bi bi-geo-alt"></i> São Paulo, SP
                </p>
            </div>
            ...
            <div class="col-md-4">
                ...
                <div>
                    <a href="https://www.instagram.com/batrip___/" class="social-icon" target="_blank">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://x.com/pradasoueu" class="social-icon" target="_blank">
