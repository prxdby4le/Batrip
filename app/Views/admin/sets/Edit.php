        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">
                    <i class="bi bi-pencil me-2"></i>Editar Conjunto
                </h4>
                
                <form method="POST" action="<?php echo BASE_URL; ?>adm/conjuntos/<?php echo $set['id']; ?>/atualizar" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="title" class="form-label">Título *</label>
                        <input type="text" class="form-control" id="title" name="title" 
                               value="<?php echo htmlspecialchars($set['title']); ?>" required>
                    </div>
                    
                    <div class="mb-3">
                        <label for="description" class="form-label">Descrição</label>
                        <textarea class="form-control" id="description" name="description" rows="4"><?php echo htmlspecialchars($set['description'] ?? ''); ?></textarea>
                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="price" name="price" 
                                       step="0.01" min="0" 
                                       value="<?php echo $set['price']; ?>" required>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-dark table-striped align-middle">
                                ...
                                <tbody>
                                    <?php foreach ($products as $p): ?>
                                        <?php 
                                        $isSelected = isset($selectedProducts[$p['id']]);
                                        $qty = $isSelected ? $selectedProducts[$p['id']] : 1;
                                        ?>
                                        <tr>
                                            <td>
                                                <input type="checkbox" 
                    ...
                    <div class="mb-3">
                        ...
                        <?php if (!empty($set['image'])): ?>
                            ...
                            ?>
                            <div class="mb-2">
                                <img src="<?= htmlspecialchars($imageUrl) ?>" alt="Imagem atual" style="max-width: 200px; max-height: 200px; object-fit: cover; border-radius: 5px;" onerror="this.onerror=null; this.src='<?= BASE_URL ?>assets/img/placeholder.svg';">
                            </div>
                        <?php endif; ?>
                        <input type="file" class="form-control" id="image" name="image" accept="image/*">
                        <small class="text-muted">Deixe em branco para manter a imagem atual. Formatos aceitos: JPG, PNG, WEBP (máx. 5MB)</small>
                    </div>
                    
                    <div class="mb-4">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="active" name="active" <?= $set['active'] ? 'checked' : '' ?>>
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-custom btn-lg">
                            <i class="bi bi-check-circle me-2"></i>Atualizar Conjunto
                        </button>
