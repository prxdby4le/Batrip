        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="product-card">
                        <div class="product-image" style="width:100%; aspect-ratio:1/1; overflow:hidden;">
                            <img src="img/fragmentado-costa.jpeg" alt="Camiseta Fragmentado Boxy" class="img-fluid rounded" style="object-fit:cover; width:100%; height:100%;">
                        </div>
                ...
                <div class="col-md-4">
                    <div class="product-card">
                        <div class="product-image" style="width:100%; aspect-ratio:1/1; overflow:hidden;">
                            <img src="img/fragmentado-frente.jpeg" alt="Camiseta Fragmentado Oversized" class="img-fluid rounded" style="object-fit:cover; width:100%; height:100%;">
                        </div>
                ...
                <div class="col-md-4">
                    <div class="product-card">
                        <div class="product-image" style="width:100%; aspect-ratio:1/1; overflow:hidden;">
                            <img src="img/spiderweb-oversized.jpeg" alt="Camiseta Fragmentado Boxy" class="img-fluid rounded" style="object-fit:cover; width:100%; height:100%;">
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="artist-card">
                                <div class="artist-avatar">
                                    <img src="img/chard-la-plaga.jpg">
                                </div>
                ...
                <div class="carousel-item">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4">
                            <div class="artist-card">
                                <div class="artist-avatar">>
                                    <img src="img/pradasoueu.jpg">
                                </div>
                                <h3 class="artist-name">pradasoueu</h3>
                                <p class="artist-genre">Cantor e CEO da Batrip</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="artist-card">
                                <div class="artist-avatar">
                                    <img src="img/mugi.png">
                                </div>
